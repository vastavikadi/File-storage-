...
# Your db channel Id
# -1002219047037
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002219071950"))
...
# Fsub 1
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002019228287"))

# Fsub 2
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002149105272"))
